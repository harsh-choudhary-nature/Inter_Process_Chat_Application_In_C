...
struct winsize w;
int fd_user1_to_user2;
int fd_user2_to_user1;
...
void* sendThread(void* args) {
    while (1) {
        ...
        getInput();
        write(fd_user1_to_user2, message, strlen(message) + 1);
        message[0]='\0';
    }
}
...
void* receiveThread(void* args) {
    ...
    while (1) {
        ...
        ssize_t bytesRead = read(fd_user2_to_user1, received, sizeof(received));
        if (bytesRead > 0) {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    fd_user1_to_user2 = open(FIFO_USER1_TO_USER2, O_WRONLY);
    fd_user2_to_user1 = open(FIFO_USER2_TO_USER1, O_RDONLY);
